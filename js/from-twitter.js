      ...
      React.createElement("div", {className: "fromTwitter bg-info"}, 
        ...
        React.createElement("div", {className: "fromTwitter-text"}, 
          React.createElement("p", null, 
            ...
            "changed ", React.createElement("bold", null, "after"), " it ", React.createElement("a", {href: "https://twitter.com/elonmusk/status/1535144423352311809", target: "_blank"}, "has been shared on social media"), "."
          ), 
          ...
          React.createElement("p", null, 
            ...
            "to donate to charities that act against ", React.createElement("a", {href: "https://naacp.org/donate", target: "_blank"}, "systemic racism"), ", ", React.createElement("a", {href: "https://donate.unwomen.org", target: "_blank"}, "sexism"), ", ", React.createElement("a", {href: "https://lgbt.foundation/donate", target: "_blank"}, "homophobia and transphobia"), "."
          ), 
